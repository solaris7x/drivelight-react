...
const TermsAndConditions = () => {
  return (
    <div className="bg-pink-700">
      <Link to="/">
        <div className="text-white text-4xl font-bold text-center py-8">
          DriveLight
        </div>
      </Link>
      <div className="bg-white text-black rounded-t-lg mx-[20%] px-10 py-5">
        ...
        <p>
          ...
          related to it, still belong to Valhiem.
        </p>
        <p>
          Valhiem is committed to ensuring that the app is as useful and
        ...
        <p>
          The DriveLight app stores and processes personal data that you have
          ...
          security features and it could mean that the DriveLight app won’t work
          properly or at all.
        </p>
        <div>
          <p>
          ...
          <ul>
            <li>
              <a
                ...
                className="text-pink-600 hover:bg-pink-700 hover:text-white p-1 m-1 rounded-md"
              >
        ...
        <p>
          You should be aware that there are certain things that Valhiem will
          ...
          Wi-Fi or provided by your mobile network provider, but Valhiem cannot
        ...
        <p>
          Along the same lines, Valhiem cannot always take responsibility for
          ...
          avail the Service, Valhiem cannot accept responsibility.
        </p>
        <p>
          With respect to Valhiem’s responsibility for your use of the app, when
          ...
          it available to you. Valhiem accepts no liability for any loss, direct
        ...
        <p>
          ...
          using the app. Valhiem does not promise that it will always update the
        ...
        <p>These terms and conditions are effective as of 2022-06-17</p>
        <p>
        ...
        <p>
          ...
          <a
            href="mailto:drivelight@trumail.ml"
            className="text-pink-600 hover:bg-pink-700 hover:text-white p-1 m-1 rounded-md"
          >
            drivelight@trumail.ml.
          </a>
        </p>
        <p>
