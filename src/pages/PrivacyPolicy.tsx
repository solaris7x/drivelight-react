  ...
  return (
    <div className="bg-pink-700">
      ...
      <div className="bg-white text-black rounded-t-lg mx-[20%] px-10 py-5">
        <h1 className="text-center text-2xl font-bold my-5">Privacy Policy</h1>
        <p>
          Valhiem built the DriveLight app as a Free app. This SERVICE is
          provided by Valhiem at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at DriveLight unless
        ...
        <p>
          ...
          but not limited to Name, Email, Google ID . The information that I
